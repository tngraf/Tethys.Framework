...
namespace Tethys.IO
{
    ...
    public enum FileStringOptions
    {
        ...
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly",
          MessageId = "Subdir", Justification = "This is the intended spelling!")]
        Subdir = 0x4000,
    } // Flags
    ...
    public class FileString
    {
        ...
        public static string GetPart(string file, FileStringOptions fileStringOptions)
        {
            ...
            if ((fileStringOptions & FileStringOptions.Folder) == 0)
            {
                ...
                int posEnd = strStart.Length;
                int pos = posEnd - 1;

                // only extend is searched
                bool extend = ((fileStringOptions & FileStringOptions.FileName) == 0);
                while (pos >= 0)
                {
        ...
        public static string AbbreviateName(string name, int maxLength, bool atLeastName)
        {
            ...
            string strBase = name;
            int fullPath = strBase.Length;

            string strFileName = GetPart(name, FileStringOptions.FileName);
            int fileName = strFileName.Length;
            ...
            // handled earlier.
            string strCur = strBase.Substring(pos);
