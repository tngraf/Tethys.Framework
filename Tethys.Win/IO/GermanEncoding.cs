...
// ===========================================================================
//
// <copyright file="GermanEncoding.cs" company="Tethys">
...
namespace Tethys.IO
{
  ...
  /// </summary>
  public class GermanEncoding : Encoding
  {
    /// <summary>
    /// Code page.
    /// </summary>
    ...
    public override string EncodingName
    {
      get
      {
        return "ASCII encoding for german language";
      }
    } // EncodingName
    ...
    {
      throw new NotSupportedException("GermanEncoding does not support GetHashCode().");
    } // GetHashCode()
    ...
    {
      return GetEncoding(GermanCodePage).GetByteCount(chars,
        index, count);
    } // GetByteCount()
    ...
    {
      return GetEncoding(GermanCodePage).GetBytes(chars, charIndex,
    ...
    public override int GetBytes(string s, int charIndex, int charCount,
      byte[] bytes, int byteIndex)
    {
      return GetEncoding(GermanCodePage).GetBytes(s, 
    ...
    public override int GetCharCount(byte[] bytes, int index, int count)
    {
      ...
      if (index < 0) 
      {
        throw new ArgumentOutOfRangeException("index", index, "index must be >= 0");
      } // if
      if (index + count > bytes.Length) 
      {
        throw new ArgumentOutOfRangeException("index", index, "index + count must be <= length");
      } // if

      return GetEncoding(437).GetCharCount(bytes, index, count);
    } // GetCharCount()
    ...
    {
      return GetEncoding(GermanCodePage).GetChars(bytes, byteIndex,
        byteCount, chars, charIndex);
    } // GetChars()
    ...
    public override int GetMaxByteCount(int charCount)
    {
      if (charCount < 0) 
      {
        throw new ArgumentOutOfRangeException("charCount", charCount,
         "charCount must be >= 0");
      } // if
    ...
    public override int GetMaxCharCount(int byteCount) 
    {
      if (byteCount < 0) 
      {
        throw new ArgumentOutOfRangeException("byteCount", byteCount,
          "byteCount must be >= 0");
      } // if
...
// ================================
// Tethys: end of germanencoding.cs
// ================================