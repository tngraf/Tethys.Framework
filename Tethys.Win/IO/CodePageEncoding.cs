...
namespace Tethys.IO
{
    ...
    public class CodePageEncoding : Encoding
    {
        ...
        {
            throw new NotSupportedException("CodePageEncoding does not support GetHashCode().");
        } // GetHashCode()
        ...
        {
            return GetEncoding(this.currentCodePage).GetByteCount(chars,
              index, count);
        } // GetByteCount()
        ...
        {
            return GetEncoding(this.currentCodePage).GetBytes(chars, charIndex,
        ...
        public override int GetBytes(string s, int charIndex, int charCount,
          byte[] bytes, int byteIndex)
        {
            return GetEncoding(this.currentCodePage).GetBytes(s,
        ...
        {
            return GetEncoding(this.currentCodePage).GetChars(bytes, byteIndex,
