...
namespace Tethys.Cryptography
{
    ...
    public sealed class CRC32 : HashAlgorithm
    {
        ...
        private static readonly uint[] PreCalcTab =
      {
        ...
        public CRC32()
        {
            HashSizeValue = HashSizeBitsCrc32;
            ...
            HashValue[0] = (byte)(this.crc >> 24);
            HashValue[1] = (byte)((this.crc & 0x00ff0000) >> 16);
            HashValue[2] = (byte)((this.crc & 0x0000ff00) >> 8);
            HashValue[3] = (byte)(this.crc & 0x000000ff);
        } // CRC32()
