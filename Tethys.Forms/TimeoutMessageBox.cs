...
namespace Tethys.Forms
{
  ...
  public static class TimeoutMessageBox
  {
    ...
    [SuppressMessage("Microsoft.Globalization",
      "CA1300:SpecifyMessageBoxOptions", Justification = "Not relevant here!")]
    public static DialogResult Show(string text, string caption,
      MessageBoxButtons buttons, MessageBoxIcon icon, int timeout)
    {
      Init(caption, timeout);
    ...
    public static DialogResult Show(string text, string caption, MessageBoxButtons buttons,
      MessageBoxIcon icon, MessageBoxDefaultButton defButton, int timeout)
    {
      Init(caption, timeout);
    ...
    [SuppressMessage("Microsoft.Globalization",
      "CA1300:SpecifyMessageBoxOptions", Justification = "Not relevant here!")]
    public static DialogResult Show(string text, string caption, MessageBoxButtons buttons,
      MessageBoxIcon icon, MessageBoxDefaultButton defButton, MessageBoxOptions options, int timeout)
    {
      Init(caption, timeout);
    ...
    [SuppressMessage("Microsoft.Globalization",
      "CA1300:SpecifyMessageBoxOptions", Justification = "Not relevant here!")]
    public static DialogResult Show(IWin32Window owner, string text, 
      string caption, MessageBoxButtons buttons, int timeout)
    {
      Init(caption, timeout);
    ...
    public static DialogResult Show(IWin32Window owner, string text, string caption,
      ...
      MessageBoxDefaultButton defButton, int timeout)
    {
      Init(caption, timeout);
    ...
    public static DialogResult Show(IWin32Window owner, string text, 
      ...
      MessageBoxDefaultButton defButton, MessageBoxOptions options, int timeout)
    {
      Init(caption, timeout);
...
// ReSharper restore InconsistentNaming
    ...
    private static void Init(string caption, int timeout)
    {
      ...
      handleHook = Win32Api.SetWindowsHookEx((int)WindowsHookCodes.WH_CALLWNDPROCRET,
        HookProc, IntPtr.Zero, Thread.CurrentThread.ManagedThreadId);
    } // Init()
      ...
      IntPtr lParam) 
    {
      ...
      if ((hookCaption != null) && (msg.message == (uint)Msg.WM_INITDIALOG)) 
      {
        ...
        int result = Win32Api.GetWindowText(msg.hwnd, text, text.Capacity);
    ...
    SuppressMessage("StyleCop.CSharp.DocumentationRules", "SA1650:ElementDocumentationMustBeSpelledCorrectly",
      Justification = "Reviewed. Suppression is OK here.")]
    private static void MessageBoxTimerProc(IntPtr hWnd, uint uMsg,
      UIntPtr idEvent, uint time) 
    {
      if (idEvent == (UIntPtr)TimerId)
      {
        ...
        int result = Win32Api.EndDialog(hWnd, (IntPtr)dw);
