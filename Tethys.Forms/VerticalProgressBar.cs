...
namespace Tethys.Forms
{
    ...
    public partial class VerticalProgressBar : UserControl
    {
        ...
        /// </summary>
        private VerticalBarBorderStyle borderStyle 
            = VerticalBarBorderStyle.Classic;
        ...
        {
            // The pos y of value
            int valueposY = y - height;

            // The height of the block
            int blockheight = width * 3 / 4;

            for (int currentpos = y; currentpos > valueposY; currentpos -= blockheight + 1)
            {
