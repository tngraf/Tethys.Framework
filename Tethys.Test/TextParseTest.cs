...
// ===========================================================================
//
// <copyright file="TextParseTest.cs" company="Tethys">
...
namespace Tethys.Test
{
    ...
    public void SetLastTokenTest()
    {
      ...
      Assert.Inconclusive("A method that does not return a value cannot be verified.");
        ...
        {
            var target = new TextParse("123ÖäÜ");
            var expected = '1';
            var actual = target.GetChar();
            Assert.AreEqual(expected, actual);
        ...
        {
            var target = new TextParse("1    23");
            var flags = ParseOptions.SkipSpace;
            var expected = '1';
            var actual = target.GetChar(flags);
            Assert.AreEqual(expected, actual);
        ...
        public void CheckFixCharTest()
        {
            ...
            catch (ParsingException pex)
            {
                ...
                Assert.AreEqual(string.Empty, pex.LastToken);
            } // catch
        ...
        public void GetFixNameTest()
        {
            ...
            expected = 0;
            target.Init("asdf");
            actual = target.GetFixName(string.Empty, flags);
            Assert.AreEqual(expected, actual);
