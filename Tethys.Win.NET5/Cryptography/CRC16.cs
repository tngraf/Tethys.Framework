...
namespace Tethys.Cryptography
{
        ...
        private static readonly uint[] Tab16 =
    {
      ...
      0x8201, 0x42C0, 0x4380, 0x8341, 0x4100, 0x81C1, 0x8081, 0x4040,
        ...
        public CRC16()
        {
            this.HashSizeValue = HashSizeBitsCrc16;
            this.HashValue = new byte[HashSizeBytesCrc16];
        ...
        public override void Initialize()
        {
            ...
            this.HashValue[0] = (byte)((this.crc & 0xff00) >> 8);
            this.HashValue[1] = (byte)(this.crc & 0x00ff);
        } // Initialize()
        ...
        protected override void HashCore(byte[] buffer, int offset, int count)
        {
            for (; count != 0; count--, offset++)
            {
                ...
                var i = (this.crc ^ buffer[offset]) & 0x00FF;
        ...
        protected override byte[] HashFinal()
        {
            ...
            this.HashValue[0] = (byte)((crcRet & 0xff00) >> 8);
            this.HashValue[1] = (byte)(crcRet & 0x00ff);
